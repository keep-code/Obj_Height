...
def get_confidence_corrected_status(session_data, height_label):
    ...
    for i, data in enumerate(session_data_sorted):
        if data['Dist'] <= 1500 and data['HeightProb'] == 80:
            ...
            if high_predictions == total_remaining:
                should_correct = True
...
def create_raw_data_sheet(labeled_data):
    ...
    for data, count, phase in labeled_data:
        ...
        # 获取置信校对后的检测状态
        confidence_corrected_status = data.get('ConfidenceCorrectedStatus', corrected_status)
        ...
        raw_results.append({
            ...
            '置信校对': confidence_corrected_status_str,  # 新增：置信度校对后的检测状态
            '置信度': data['HeightProb'],
...
if __name__ == "__main__":
    ...
    output_path = r"D:\PythonProject\data\csv_files\4\145_174"
