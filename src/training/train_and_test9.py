...
class ObstacleHeightClassifier:
    ...
    def __init__(self, config=None):
        ...
        self.config = {
            ...
            'plot_dir': './plots',
            'results_dir': './results',
            'misclassified_dir': './misclassified',  # 错误样本专用目录
...
if __name__ == "__main__":
    ...
    OUTPUT_CONFIG = {
        ...
        'misclassified_dir': r'D:\PythonProject\results\misclassified_results',  # 错误样本保存目录
        'auto_create_dirs': True,
        'encoding': 'utf-8-sig',  # 解决中文乱码问题

        # 训练参数
        'test_size': 0.0,  # 改回0.0，使用全部数据训练（错误样本主要来自预测阶段）
        'random_state': 42,
    ...
    #     files = os.listdir(misclassified_dir)
    #     if files:
    #         print(f"\n错误样本文件列表:")
    #         for file in files:
