...
def main():
    ...
    try:
        test_results = classifier.predict_test_data(r'D:\PythonProject\data\processed_data\train_group2.csv', 'D:\PythonProject\results\prediction_results\Prediction_Results.csv')
        print("\n预测完成！")
